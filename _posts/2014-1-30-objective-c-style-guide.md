...
It's pretty similar to that of the [NYTimes](https://github.com/NYTimes/objective-c-style-guide). This document is also based off that, as they structured it excellently.
